...
public final class IntaveControl {
    ...
    public static boolean DEBUG_MOVEMENT_IGNORE = false;
    ...
    public static boolean DEBUG_TELEPORT_LOCKS = false;
    ...
    public static final boolean DEBUG_MOVEMENT_BLOCK_FALLEN_UPON = false;
    ...
    public static final OperationalMode SAMPLE_OPERATIONAL_MODE = OperationalMode.LOCAL_STORAGE;
