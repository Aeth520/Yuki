...
@CheckData(name = "ElytraB (Jump)", configName = "ElytraB", type = CheckType.ELYTRA, description = "Started gliding without jumping", experimental = true)
public final class ElytraB extends Check implements PostPredictionCheck {
