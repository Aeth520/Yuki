...
@CheckData(name = "ElytraC", configName = "ElytraC", type = CheckType.ELYTRA, description = "Started gliding too frequently")
public final class ElytraC extends Check implements PostPredictionCheck {
