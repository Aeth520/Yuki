package cn.aetheris.yuki.entity.tag;
...
public final class SyncedTags {
    ...
    private static final ServerVersion VERSION = Yuki.getInstance().getPacketEventsManager().getServerVersion();
    ...
    public SyncedTags(PlayerData player) {
        ...
        trackTags(id -> StateTypes.getById(VERSION.toClientVersion(), id),
    ...
    @SafeVarargs
    private <T> void trackTags(Function<Integer, T> remapper, SyncedTag.Builder<T>... syncedTags) {
        ...
        synced.put(SyncedTags.BLOCK, tags);
    }
