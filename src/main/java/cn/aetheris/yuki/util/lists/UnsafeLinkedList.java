...
public class UnsafeLinkedList<E>
    ...
    public UnsafeLinkedList<E> reversed() {
        UnsafeLinkedList<E> reversedList = new UnsafeLinkedList<>();
    ...
    public static class ReverseOrderLinkedListView<E> extends UnsafeLinkedList<E> implements java.io.Externalizable {
        final UnsafeLinkedList<E> list;
        final List<E> rlist;
        final Deque<E> rdeque;

        ReverseOrderLinkedListView(UnsafeLinkedList<E> list, List<E> rlist, Deque<E> rdeque) {
            this.list = list;
            this.rlist = rlist;
            this.rdeque = rdeque;
        }
    ...
    public class Node<E> {
        ...
        public void unlink() {
            UnsafeLinkedList.this.unlink((Node) this);
        }
    }
    ...
    public final class LLSpliterator<E> implements Spliterator<E> {
