...
import cn.aetheris.yuki.listener.packets.dragon.PacketEntityEnderDragon;
...
public final class CompensatedEntities {
    ...
    public void addEntity(int entityID, UUID uuid, EntityType entityType, Vector3d position, float xRot, int data) {
        ...
        if (EntityTypes.HAPPY_GHAST.equals(entityType)) {
            ...
            packetEntity = new PacketEntityTrackYaw(player, uuid, entityType, position.getX(), position.getY(), position.getZ(), xRot);
            ...
            packetEntity = new PacketEntityGuardian(player, uuid, entityType, position.x, position.y, position.z, false); 
    ...
    public void updateEntityMetadata(int entityID, List<EntityData<?>> watchableObjects) {
        ...
        if (entity.isAgeable) {
            int id;
            if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_8_8)) {
                id = 12;
            } else if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_9_4)) {
                id = 11;
            } else if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_13_2)) {
                id = 12;
            } else if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_14_4)) {
                id = 14;
        ...
        if (entity instanceof PacketEntityShulker shulker) {
            ...
            if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_9_4)) {
                id = 11;
            } else if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_13_2)) {
                id = 12;
            } else if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThanOrEquals(ServerVersion.V_1_14_4)) {
        ...
        if (entity instanceof PacketEntityRideable rideable) {
            ...
            if (entity.type == EntityTypes.PIG) {
                if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isNewerThanOrEquals(ServerVersion.V_1_21_5))
                    offset = 1;
        ...
        if (entity instanceof PacketEntityHorse horse) {
            if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isNewerThanOrEquals(ServerVersion.V_1_9_4)) {
                int offset = 0;
                ...
                if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isNewerThanOrEquals(ServerVersion.V_1_20)) {
        ...
        if (entity instanceof PacketEntityArmorStand) {
            ...
            if (armorStandByte != null) {
                ...
                entity.isBaby = (info & 0x01) != 0; 
                ((PacketEntityArmorStand) entity).isMarker = (info & 0x10) != 0;
            }
        }

        if (entity instanceof PacketEntityGuardian && Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThan(ServerVersion.V_1_11)) {
            int index;
            ...
            } else if (Yuki.getInstance().getPacketEventsManager().getServerVersion().isOlderThan(ServerVersion.V_1_10)) {
                index = 11;
                isElderlyBitMask = 0x04;
            } else {
                index = 12;
