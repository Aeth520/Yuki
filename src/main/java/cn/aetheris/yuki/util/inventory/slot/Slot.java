...
public class Slot {
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, PlayerData p_150644_) {
    ...
    public void onTake(PlayerData p_150645_, ItemStack p_150646_) {

    }

    
    public boolean allowModification(PlayerData p_150652_) {
        return this.mayPickup(p_150652_) && this.mayPlace(this.getItem());
    }

    public boolean mayPickup(PlayerData p_40228_) {
        return true;
    }
}
