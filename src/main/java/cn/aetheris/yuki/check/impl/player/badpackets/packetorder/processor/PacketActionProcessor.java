package cn.aetheris.yuki.check.impl.player.badpackets.packetorder.processor;
...
@Getter
public final class PacketActionProcessor extends Check implements PacketCheck {
    ...
    public PacketActionProcessor(final PlayerData player) {
        super(player);
    }
