...
import cn.aetheris.yuki.block.collision.datatypes.HitBoxFactory;
...
public final class DynamicHitboxPane extends DynamicConnecting implements HitBoxFactory {
    ...
    private boolean isModernVersion(ClientVersion version) {
        return Yuki.getInstance().getPacketEventsManager().getServerVersion().isNewerThanOrEquals(ServerVersion.V_1_13)
